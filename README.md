...
I enjoy solving real-world challenges by combining technology with business. Curious by nature and persistent by choice, I'm always exploring new ideas and building AI-powered tools, automation workflows, and full-stack applications that make everyday tasks smarter and simpler.

I believe persistence beats perfection, and innovation isn't just about having ideas—it's about bringing them to life.
...
| Focus | Details |
|------|---------|
| Working On | Enhancing a real-time chat platform and improving a stock market application with live data, analytics and learning tools. |
...
| Collaborating | Full-Stack Applications • AI & Automation • Developer Tools |
| Looking for Help | Cloud-native architecture • Distributed systems • Production deployments |
| Ask Me About | React • JavaScript • Python • REST APIs • DSA • Automation • Problem Solving |
| Fun Fact | My first Playwright automation project took a week. A year later I completed a similar scraping project in just four hours. |

---

<h2 align="center">Featured Projects</h2>

> Repository cards will be added here after all repositories are polished.

- **Corporate Intelligence Automation** — Playwright-based browser automation with Cloudflare handling.
- **Real-Time Chat Platform** — Socket.IO powered full-stack messaging application.
- **Stock Market Learning Platform** — Live market data with educational features.
